            ...
            <div class="mockup-window heatmap-window">
              ...
              <div class="mockup-body" style="min-height: auto; padding: 30px;">
                <div class="heatmap-wrapper" style="width: 100%; border: 1px solid rgba(255,255,255,0.05); background: rgba(20,20,20,0.8);">
                  ...
                  <div class="heatmap-months-container" style="padding-top: 12px; border-top: 1px solid var(--border-muted);">
                    <div class="heatmap-month-block" style="flex: 1;">
                      <div class="heatmap-month-grid" id="mockup-heatmap-grid" style="gap: 4px;">
                        <!-- Generated by JS -->
                      </div>
                    </div>
                  </div>
